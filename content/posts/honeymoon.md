...
<pre class="scene" aria-label="palm tree on a beach with a sun and a sailboat">
<span class="sun">                                          .   .
                                           \ /
                                          .-' '-.
                                         .' o@o '.
...
<span class="frond">              'Xx   xX*,
             ,*xXXx_xXx
              _xXXXXXxx*,
             ,*XXx@x@Xx
               X @|@@ `x
             '   </span><span class="trunk">||
                 ||
                 ||
                 ||
                 ||
                 ||
                 ||</span>
<span class="sand">                 /sssssss.
                /sssssSSSSsssssss.
               /ssssSSSSSSSSSSsssssssss.</span>
<span class="sea">~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
 ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~</span>
</pre>

Sandy and I went to Maui, Hawaii for our honeymoon. We stayed at the Westin in Kaanapali. Here are some of the cool things we did with a bunch of photos (which are all shot on film).

- Monkeypod's happy hour
- Trilogy excursion
- Shaved ice in Lahaina (twice)
- Got a private cabana on the beach for a day
- Ate a true fried McDonald's apple pie (apparently this is one of the few that still fries them)
- Mama's fish house
- Snorkeled
